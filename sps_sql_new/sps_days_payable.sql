...
-- DML SCRIPT: SPS Refact Full Refresh for {{ params.project_id }}.{{ params.dataset.cl }}.sps_days_payable
...
SELECT
  ...
  END AS dpo,
  -- NEW: Ingredientes descompuestos para cálculo correcto en Tableau
  -- Tableau formulas:
