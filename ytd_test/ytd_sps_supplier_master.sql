CREATE OR REPLACE TABLE `dh-darkstores-live.csm_automated_tables.ytd_sps_supplier_master`
...
FROM base b
LEFT JOIN `dh-darkstores-live.csm_automated_tables.ytd_sps_supplier_scoring` sc
...
LEFT JOIN `dh-darkstores-live.csm_automated_tables.ytd_sps_supplier_segmentation` seg
