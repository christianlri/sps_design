CREATE OR REPLACE TABLE `{{ params.project_id }}.rl_dmart._srm_supplier_scorecard_operations_categories_l3_rough` AS
...
WITH
 ...
 products_base AS (
    ...
    SELECT
    global_entity_id, sku_id,supplier_id, brand_owner_name, level_one,level_two,level_three
