CREATE OR REPLACE TABLE `{{ params.project_id }}.rl_dmart._srm_supplier_efficiency_category_l2_rough` AS
...
filtered_supplier AS (
 ...
 products AS (
    ...
    SELECT
    global_entity_id, sku_id, level_one, level_two, brand_owner_name
