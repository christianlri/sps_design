CREATE OR REPLACE TABLE `{{ params.project_id }}.rl_dmart._srm_supplier_efficiency_category_l1_rough` AS
...
filtered_supplier AS (
 ...
 products AS (
    ...
    SELECT
    global_entity_id, sku_id, level_one, brand_owner_name
...
final AS (
  ...
  WHERE
    e.partition_month BETWEEN '2023-03-01' AND CURRENT_DATE()
    AND e.is_listed
),
