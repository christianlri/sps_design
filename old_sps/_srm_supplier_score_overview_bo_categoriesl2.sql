CREATE OR REPLACE TABLE `{{ params.project_id }}.rl_dmart._srm_supplier_score_overview_bo_categoriesl2` AS 
-- FORMER: _srm_supplier_scorecard_supplier_score_overview_bo_categories_l2
WITH base AS (
...
FROM
 `fulfillment-dwh-production.rl_dmart._srm_supplier_scorecard_supplier_categories_l2_rough` as o
...
FROM
 `fulfillment-dwh-production.rl_dmart._srm_supplier_efficiency_category_l2_rough`  as o
...
FROM
`fulfillment-dwh-production.rl_dmart._srm_supplier_scorecard_operations_categories_l2_rough` as o
...
FROM
`fulfillment-dwh-production.rl_dmart._srm_supplier_availability_category_l2_rough`
    ...
    CASE 
        ...
        WHEN b.time_granularity = 'Quarterly' THEN 
            LAG(b.Net_Sales_EUR, 4) OVER (
                PARTITION BY b.country_code, b.supplier_name, b.supplier_id, b.time_granularity, b.division_type, b.level_one, b.level_two, b.brand_owner_name
                ORDER BY 
