CREATE OR REPLACE TABLE `{{ params.project_id }}.rl_dmart._srm_supplier_scorecard_supplier_categories_l3_rough`  AS 
...
WITH 
 ...
 products AS (
    ...
    categ_level_one as level_one,
    categ_level_two as level_two,
    categ_level_three as level_three,
...
FROM (
    SELECT
        ...
        r.supplier_name,
        r.term_value_type,
        r.sku_categ_level_one as level_one,
        r.sku_categ_level_two as level_two,
        r.sku_level_three as level_three,
...
GROUP BY ALL),
  ...
  division_supplier_final_monthly AS (  
    ...
    CAST(os.order_month AS STRING) as time_period,
    CAST(o.supplier_id AS STRING) as supplier_id,
    o.supplier_name,
    CAST(NULL AS STRING) AS brand_owner_name,
    o.supplier_name as segment_name,
...
ROUND((Net_Purchases),3) as Net_Purchases
    ...
    AND olg.level_one = o.level_one
    AND olg.level_two = o.level_two
    AND olg.level_three = o.level_three
    ...
    AND CAST(bm.supplier_name AS STRING) = CAST(o.supplier_name AS STRING)
    AND bm.month = o.month
    AND bm.level_one = o.level_one
    AND bm.level_two = o.level_two
    AND bm.level_three = o.level_three
    ...
    AND CAST(np.supplier_name AS STRING) = CAST(o.supplier_name AS STRING)
    AND np.month = o.month
    AND np.level_one = o.level_one
    AND np.level_two = o.level_two
    AND np.level_three = o.level_three
...
ROUND((Net_Purchases),3) as Net_Purchases
  ...
  --------- Commercial Metrics------------------------
    ...
    AND o.level_one = olg.level_one
    AND o.level_two = olg.level_two
    AND o.level_three = olg.level_three
  ...
  --------- Commercial Metrics------------------------
    ...
    ROUND(IFNULL(SUM(o.total_discount_lc),0)) AS total_discount_lc,
    ------- Order level data for the supplier---------------
    ROUND(AVG(count_of_orders),0) AS count_of_orders,
...
ROUND((Net_Purchases),3) as Net_Purchases
    ...
    AND
    o.level_one = olg.level_one
    AND
    o.level_two = olg.level_two
    AND
    o.level_three = olg.level_three
    ...
    AND
    bm.level_one = o.level_one
    AND
    bm.level_two = o.level_two
    AND
    bm.level_three = o.level_three
